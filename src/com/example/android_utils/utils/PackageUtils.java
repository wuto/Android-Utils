...
import com.example.android_utils.utils.ShellUtils.CommandResult;
...
public class PackageUtils {
	...
	public static final int install(Context context, String filePath) {
		if (PackageUtils.isSystemApplication(context)
				|| ShellUtils.checkRootPermission()) {// 判断手机是否root
	...
	/**
	 * 
	 * apk install package normal by system intent 默认安装
	 * 
	 * @param context
	 * @param filePath
	...
	/**
	 * 
	 * uninstall package normal by system intent 卸载应用
	 * 
	 * @param context
	 * @param packageName
	 *            package name of app
	...
	/**
	 * whether context is system application 应用是否是系统应用
	 * 
	 * @param context
	 * @return
	 */
	...
	/**
	 * whether packageName is system application 应用是否是系统应用
	 * 
	 * @param context
	 * @param packageName
	 * @return
	...
	/**
	 * 
	 * 获得app的版本号 get app version code
	 * 
	 * @param context
	 * @return
	 */
